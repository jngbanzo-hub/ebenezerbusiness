...
test("le tableau de bord expose les modules sur des routes dédiées", () => {
  for (const path of ["encaissements", "caisse", "depenses", "stockages", "transferts", "statistiques-expediteurs", "statistiques-manifeste", "statistiques-expeditions", "suivi-expeditions"]) {
