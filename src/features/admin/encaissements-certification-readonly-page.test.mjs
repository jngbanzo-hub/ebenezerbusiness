...
test("façade affiche l'agrégation F/M et les témoins sans mutation", () => {
  ...
  for (const label of ["modernManifestAudit", "Audit inversé Manifeste COO", "Codes restant", "À VÉRIFIER", "Codes restant à encaisser", "NON CERTIFIABLE"]) assert.match(page, new RegExp(label));
