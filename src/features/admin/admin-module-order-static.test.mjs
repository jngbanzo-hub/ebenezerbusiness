...
test("les routes restent inchangées et État du système suit les cartes", () => {
  for (const route of ["rapport-journalier", "anomalies", "recherche-globale-colis", "encaissements", "depenses", "caisse", "stockages", "transferts", "statistiques-expediteurs", "statistiques-manifeste", "statistiques-expeditions", "suivi-expeditions", "qr-associations"]) {
