...
type Parcel = { parcelId: string; trackingCode: string; displayCode?: string; agency: string; weightKg: number; status: string; arrivedAt: string | null; arrivalAgent: string | null };
